...
: '
  Utility script to submit a SLURM job array of N jobs with vast-tools align. If merge.tab in SAMPLE_NAME\t\GROUP_NAME
  format exists in the project directory, vast-tools first merges samples before combining the output.
